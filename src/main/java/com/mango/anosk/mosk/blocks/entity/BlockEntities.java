...
public class BlockEntities {
    ...
    public static BlockEntityType<PulleyBlockEntity> PULLEY_BLOCK_ENTITY;
    ...
    public static void InitEntities() {
        ...
        PULLEY_BLOCK_ENTITY = Registry.register(Registry.BLOCK_ENTITY_TYPE, "mosk:pulley_block_entity", FabricBlockEntityTypeBuilder.create(PulleyBlockEntity::new, Blocks.PULLEY_BLOCK).build(null));
    }
}
