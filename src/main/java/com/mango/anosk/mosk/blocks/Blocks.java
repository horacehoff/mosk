...
public class Blocks {
    ...
    public static final MushroomParasiteBlock MUSHROOM_PARASITE = new MushroomParasiteBlock(FabricBlockSettings.of(Material.SOLID_ORGANIC).hardness(0.2f).nonOpaque());
