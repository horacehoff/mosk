...
public class Items {
    ...
    public static final Item PULLEY_ITEM = Registry.register(Registry.ITEM, new Identifier("mosk", "pulley_block"), new BlockItem(Blocks.PULLEY_BLOCK, new Item.Settings().group(ItemGroup.REDSTONE)));
