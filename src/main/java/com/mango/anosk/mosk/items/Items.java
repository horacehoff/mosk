...
public class Items {
    ...
    public static void initItems() {
        ...
        Registry.register(Registry.ITEM, new Identifier("mosk", "mushroom_parasite_block"), new BlockItem(Blocks.MUSHROOM_PARASITE_BLOCK, new Item.Settings().group(ItemGroup.MISC)));
    }
}
